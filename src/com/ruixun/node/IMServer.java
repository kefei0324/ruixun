...
import com.ruixun.node.pushlistener.NIOPushListener;
import com.ruixun.node.tcpconnector.NIOTcpConnector;
...
public class IMServer {
	...
	public static IMServer server;// 实例

	private boolean stoped = false;

	int workerNum = PropertyUtil.getPropertyInt("CLIENT_UDP_WORKER_THREAD");// FIXME
																			// work
																			// threads

...
public class UdpConnector {
	...
	public void start() throws Exception {
		...
		// antenna.socket().setSendBufferSize(1024 * 1024 *
		// PropertyUtil.getPropertyInt("CLIENT_UDP_BUFFER_SEND"));
		System.out.println("udp connector recv buffer size:" + antenna.socket().getReceiveBufferSize());
		// System.out.println("udp connector send buffer size:" +
		// antenna.socket().getSendBufferSize());
